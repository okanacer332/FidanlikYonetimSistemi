...
public class OrderService {
    ...
    public Order createOrder(OrderCreateRequest request, String userId, String tenantId) {
        ...
        for (OrderItemDto itemDto : request.getItems()) {
            // TODO: Fiyatı Plant modelinden veya ayrı bir Fiyat Listesinden çek. Şimdilik sabit bir fiyat varsayıyoruz.
            BigDecimal price = new BigDecimal("100.00"); // Örnek fiyat
        ...
        // Siparişi oluştur ve kaydet. Bu, relatedDocumentId olarak kullanılacak bir ID üretecektir.
        ...
        // Stoktan düşme işlemlerini gerçekleştir
        for (Order.OrderItem item : savedOrder.getItems()) {
            stockService.changeStock(
                    ...
                    savedOrder.getId(),
                    "Sipariş No: " + savedOrder.getOrderNumber(),
                    userId,
                    tenantId
            );
        }
